...
'''
THIS IS JUST A COPY FROM seld-dcase2022
'''
def get_params(argv='1'):
    ...
    params = dict(
        ...
        dataset_dir = '/mnt/d/Projects/datasets/DCASE2021_SELD_dataset',

        # OUTPUT PATHS
        # feat_label_dir='DCASE2020_SELD_dataset/feat_label_hnet/',  # Directory to dump extracted features and labels
        feat_label_dir='/mnt/d/Projects/datasets/DCASE2021_SELD_dataset/seld_feat_label',
